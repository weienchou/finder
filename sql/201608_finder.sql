...
# Database: finder
# Generation Time: 2016-08-01 09:16:41 +0000
# ************************************************************
...
VALUES
	('005d9e2bdbd780f0906bcdda98a1679d','UDN','','http://shopping.udn.com/mall/cus/search/SearchAction.do?keyword={$data}&cid=&sort=weight&pageSize={$pageno}&start={$page}','http://shopping.udn.com/mall/cus/search/SearchAjaxService.inw?method=cateTreeview&keyword={$data}&cid={$category}','','',5,'2016-08-01 15:35:27'),
	...
	('c0f95b42a2dc26ee16f357c9d8c673e1','GOHAPPY','http://www.gohappy.com.tw/ec2/search?sid=&hotNum=0&search={$data}','http://www.gohappy.com.tw/ec2/searchCate','http://m.gohappy.com.tw/smartphone/SearchAdv.do?searchs={$data}&sids={$cate_cid}&pageindex={$page}&cateLvs={$lv}&cid={$cate}&pageno={$pageno}','http://m.gohappy.com.tw/smartphone/SearchAdv.do?display=2&pageindex={$page}&pageno={$pageno}&searchFlag=firstSearch&firstTime=0&search={$data}','http://img.gohappy.com.tw/images/product/{$data}',0,'2016-07-25 11:53:57'),
